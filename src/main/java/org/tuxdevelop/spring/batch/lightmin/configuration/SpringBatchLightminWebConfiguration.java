    ...
    public WebMvcConfigurerAdapter webMvcConfigurerAdapter() {
        return new WebMvcConfigurerAdapter() {
            ...
            public void addViewControllers(final ViewControllerRegistry viewControllerRegistry) {
                ...
                viewControllerRegistry.addViewController("/jobs/execution/{jobExecutionId}")
                        .setViewName("jobExecution");
                ...
                viewControllerRegistry.addViewController("/jobLaunchers").setViewName("jobLauncher");
            }
        };
    }
