...
@Configuration
@ComponentScan(basePackages = "org.tuxdevelop.spring.batch.lightmin", excludeFilters = { @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = SpringBatchLightminWebConfiguration.class) })
