...
The documentation can be found at https://github.com/tuxdevelop/spring-batch-lightmin/tree/0.5.x/spring-batch-lightmin-documentation/spring-batch-lightmin-documentation/src/main/doc/spring_batch_lightmin.html[Spring Batch Linghtmin Documentation]
