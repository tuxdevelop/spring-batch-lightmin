...
public class LightminServerDiscoveryConfiguration {
    ...
    public DiscoveryRegistrationBean discoveryRegistrationBean(final RegistrationBean registrationBean,
        ...
        final RestTemplate restTemplate = CommonServerConfiguration.RestTemplateFactory.getRestTemplate(lightminServerProperties);
