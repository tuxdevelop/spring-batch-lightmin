...
public abstract class CommonRegistrationBean implements ApplicationEventPublisherAware, RegistrationBean {
    ...
    public CommonRegistrationBean(final LightminApplicationRepository lightminApplicationRepository) {
    ...
    public LightminClientApplication register(final LightminClientApplication lightminClientApplication) {
        ...
        final String applicationId = determineApplicationId(lightminClientApplication);
